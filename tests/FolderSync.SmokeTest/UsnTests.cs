...
namespace FolderSync.SmokeTest
{
    ...
    public static class UsnTests
    {
        ...
        public static async Task<int> RunAll()
        {
            ...
            await TestRealtimeEngine();
            await TestRealtimeLongLivedWithNoise();   // GUI 场景复刻：长挂+噪声后不丢事件
            TestIntervalEngine();
        ...
        private static async Task TestRealtimeLongLivedWithNoise()
        {
        ...
        private static async Task TestRealtimeEngine()
        {
